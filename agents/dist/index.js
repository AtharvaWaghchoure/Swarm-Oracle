...
async function createDataCollectorAgents(coordinator, config) {
    const agents = [
...
async function createAnalystAgents(coordinator, config) {
    const agents = [
        new AnalystAgent({
...
async function createDeliberationAgents(coordinator, config) {
    const agents = [
...
async function createExecutionAgents(coordinator, config) {
    const agents = [
        new ExecutionAgent({
            id: 'risk-manager',
            type: 'risk_manager',
